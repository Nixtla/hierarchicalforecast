...
**Args:**
 ...
 - <b>`S`</b> (Frame):  DataFrame with summing matrix of size `(base, bottom)`, see [aggregate function](https://nixtlaverse.nixtla.io/hierarchicalforecast/utils#function-aggregate). 
