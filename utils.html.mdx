...
Type | Description
---- | -----------
<code>[tuple](#tuple)[[FrameT](#narwhals.typing.FrameT), [FrameT](#narwhals.typing.FrameT) \| [SMatrix](#hierarchicalforecast.utils.SMatrix), [dict](#dict)]</code> | tuple[FrameT, FrameT | SMatrix, dict]: Y_df, S_df, tags Y_df: Hierarchically structured series. S_df: Summing dataframe. When ``sparse_s=True``, returns an     :class:`SMatrix` instead of a DataFrame. tags: Aggregation indices.
