---
description: Geographical Hierarchical Forecasting on Australian Prison Population
  Data
...
results](/hierarchicalforecast/examples/./imgs/australianprisonpopulation-results-fable.png)
