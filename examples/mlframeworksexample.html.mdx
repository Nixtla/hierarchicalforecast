...
monthly series from 1998 to 2016, it is organized geographically and by
...
hierarchical forecasting studies has used the dataset in the past. The
dataset can be accessed in the [MinT reconciliation
...
![](./mlframeworksexample_files/figure-markdown_strict/cell-6-output-1.png)
...
We find that XGB with MinTrace(mint_shrink) reconciliation results in
the lowest CRPS score on the test set, thus giving us the best
...
![](./mlframeworksexample_files/figure-markdown_strict/cell-18-output-1.png)
...
![](./mlframeworksexample_files/figure-markdown_strict/cell-19-output-1.png)
