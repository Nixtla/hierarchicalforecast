...
``` text
c:\Users\ospra\miniconda3\envs\hierarchicalforecast-backup\lib\site-packages\utilsforecast\processing.py:130: PerformanceWarning: DataFrame is highly fragmented.  This is usually the result of calling `frame.insert` many times, which has poor performance.  Consider joining all columns at once using pd.concat(axis=1) instead. To get a de-fragmented frame, use `newframe = frame.copy()`
  df[names] = values
c:\Users\ospra\miniconda3\envs\hierarchicalforecast-backup\lib\site-packages\utilsforecast\processing.py:130: PerformanceWarning: DataFrame is highly fragmented.  This is usually the result of calling `frame.insert` many times, which has poor performance.  Consider joining all columns at once using pd.concat(axis=1) instead. To get a de-fragmented frame, use `newframe = frame.copy()`
  df[names] = values
c:\Users\ospra\miniconda3\envs\hierarchicalforecast-backup\lib\site-packages\utilsforecast\processing.py:130: PerformanceWarning: DataFrame is highly fragmented.  This is usually the result of calling `frame.insert` many times, which has poor performance.  Consider joining all columns at once using pd.concat(axis=1) instead. To get a de-fragmented frame, use `newframe = frame.copy()`
