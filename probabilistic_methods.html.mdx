...
1. Compute `residuals` and obtain rank permutations.
...
1. Apply recursively through the hierarchical structure:
   ...
   1. Obtain children's empirical joint using sample reordering copula.
   1. From the children's joint obtain the aggregate series's samples.
